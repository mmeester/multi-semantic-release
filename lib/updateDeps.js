...
<<<<<<< HEAD
=======
>>>>>>> 5323510 (test(updateDeps): tests for ignore strategy of updateDeps)

	//if bumpStrategy is ignore, return the current version
...
>>>>>>> 54140d5 (fix(deps): prevent dependencies from being bumped by MSR with additional option)
=======
>>>>>>> 5323510 (test(updateDeps): tests for ignore strategy of updateDeps)
	//no change...
